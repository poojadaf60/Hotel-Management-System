...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Poppins',sans-serif; }
        ...
        .card {
            background: white; padding: 35px; border-radius: 15px; box-shadow: 0 8px 20px rgba(0,0,0,0.12);
        ...
        input:focus { border-color: #f39c12; box-shadow: 0 0 8px rgba(243,156,18,0.2); }

        .btn-checkout {
            width: 100%; padding: 14px; background: #f39c12; color: white; border: none;
        ...
        .btn-checkout:hover { background: #e08e0b; }
...
<div class="sidebar">
    ...
    <a href="CheckInServlet">✅ Check In</a>
    <a class="active" href="CheckOutServlet">🚪 Check Out</a>
...
<div class="main">
    ...
    <div class="navbar">
        <div style="display:flex;align-items:center;gap:15px;">
            ...
            <h2 style="margin:0;font-size:20px;color:#273340;"><i class="fa-solid fa-door-open"></i> Check-Out</h2>
        </div>
    ...
    <div class="content">
        <div class="card">
            <h2><i class="fa-solid fa-sign-out-alt"></i> Guest Check-Out</h2>

            <%
                String error = (String) request.getAttribute("error");
                if (error != null) {
            %>
                <div class="error"><i class="fa-solid fa-exclamation-circle"></i> <%= error %></div>
            <%
                }
                String info = (String) request.getAttribute("info");
                if (info != null) {
            %>
                <div class="info"><i class="fa-solid fa-info-circle"></i> <%= info %></div>
            <%
                }
            %>
            ...
            <form action="CheckOutServlet" method="post">
                <div class="form-group">
                    ...
                    <input type="number" id="bookingId" name="bookingId" placeholder="e.g., 101" required>
                </div>
                <button type="submit" class="btn-checkout"><i class="fa-solid fa-check"></i> Check Out</button>
            </form>
