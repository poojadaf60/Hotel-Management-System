...
<div class="main">
    ...
    <div class="navbar">
        <div style="display:flex;align-items:center;gap:15px;">
            ...
            <h2 style="margin:0;font-size:20px;color:#273340;"><i class="fa-regular fa-credit-card"></i> Add Payment</h2>
        </div>
    ...
    <div class="content">
        ...
        <div class="container">
            <h2><i class="fa-solid fa-circle-plus"></i> Add New Payment</h2>

            <%
                String err = request.getParameter("msg");
                if ("error".equals(err)) {
            %>
                <div class="error-box"><i class="fa-solid fa-exclamation-circle"></i> Unable to add payment. Please try again.</div>
            <%
                }
            %>
            ...
            <form action="PaymentServlet" method="post">
                ...
                <div class="form-group">
                    <label><i class="fa-regular fa-hashtag"></i> Booking ID</label>
                    <input type="number" name="bookingId" placeholder="Enter Booking ID" required>
                </div>

                <div class="form-group">
                    <label><i class="fa-regular fa-money-bill-1"></i> Amount (₹)</label>
                ...
                <div class="form-group">
                    <label><i class="fa-regular fa-calendar"></i> Payment Date</label>
                ...
                <div class="buttons">
                    <button class="btn-save" type="submit"><i class="fa-solid fa-floppy-disk"></i> Save Payment</button>
                    <a href="PaymentManagementServlet" class="btn-cancel"><i class="fa-solid fa-xmark"></i> Cancel</a>
                </div>
